...
Table: users  (site visitors who sign up)
  id            INTEGER PRIMARY KEY AUTOINCREMENT
  name          TEXT NOT NULL
  last_name     TEXT NOT NULL
  email         TEXT NOT NULL UNIQUE
  password_hash TEXT NOT NULL   -- SHA-256 hex digest of the raw password
  linkedin_url  TEXT            -- must be a linkedin.com URL
  mobile_number TEXT
  avatar        TEXT            -- 2-letter initials
  status        TEXT DEFAULT 'pending'  -- pending | approved | rejected
  reject_reason TEXT
  submitted_at  TEXT            -- ISO-8601 timestamp (UTC)

Table: agent_buyers  (users who purchase an agent)
  id            INTEGER PRIMARY KEY AUTOINCREMENT
  name          TEXT NOT NULL
  last_name     TEXT NOT NULL
  email         TEXT NOT NULL
...
Table: jobs  (populated by linkedin-scan.mjs)
  id         INTEGER PRIMARY KEY AUTOINCREMENT
  title      TEXT NOT NULL
...
GENERATED_RESUMES_DIR = os.path.join(os.path.dirname(__file__), "resumes", "generated")
